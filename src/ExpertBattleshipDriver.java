...
public class ExpertBattleshipDriver extends Canvas implements MouseListener
{
    ...
    public ExpertBattleshipDriver()
    {
        battleship = new Battleship();
        battleship.addPlayer(new HumanPlayer("Mr. Hubbard"));
        battleship.addPlayer(new HackerComputerPlayer("AlphaBattleship"));
